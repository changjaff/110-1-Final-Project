...
<body>
    <form id="form1" runat="server">
        ...
        <asp:RadioButtonList ID="rb_1" runat="server">
             <asp:ListItem>未滿12歲(10)</asp:ListItem>
             <asp:ListItem>12-64歲(10)</asp:ListItem>
             <asp:ListItem>65歲以上(10)</asp:ListItem>
        </asp:RadioButtonList>

        <asp:Label runat="server" Text="2. 請問您的性別為："></asp:Label>
        <asp:RadioButtonList ID="rb_2" runat="server">
             <asp:ListItem>男(10)</asp:ListItem>
             <asp:ListItem>女(10)</asp:ListItem>
        </asp:RadioButtonList>

        <asp:Label runat="server" Text="3. 一般來說，您認為您目前的健康狀況是："></asp:Label>
        <asp:RadioButtonList ID="rb_3" runat="server">
             <asp:ListItem>很好(10)</asp:ListItem>
             <asp:ListItem>普通(7)</asp:ListItem>
            <asp:ListItem>不好(4)</asp:ListItem>
        </asp:RadioButtonList>
        ...
        <asp:RadioButtonList ID="rb_4" runat="server">
             <asp:ListItem>沒有健康問題(10)</asp:ListItem>
             <asp:ListItem>有健康問題，但沒有受到限制(7)</asp:ListItem>
             <asp:ListItem>有受到限制，但不嚴重(5)</asp:ListItem>
             <asp:ListItem>受到嚴重的限制(3)</asp:ListItem>
        </asp:RadioButtonList>
        ...
        <asp:RadioButtonList ID="rb_5" runat="server">
             <asp:ListItem>沒有(10)</asp:ListItem>
             <asp:ListItem>有(5)</asp:ListItem>
        </asp:RadioButtonList>
       ...
       <asp:Label runat="server" Text="6. 您是不是曾經患有高血壓？"></asp:Label>
        ...
        <asp:RadioButtonList ID="rb_8" runat="server">
             <asp:ListItem>沒有困難(10)</asp:ListItem>
             <asp:ListItem>相當困難(7)</asp:ListItem>
             <asp:ListItem>完全做不到(4)</asp:ListItem>
        </asp:RadioButtonList>

        <asp:Label runat="server" Text="9. 請問您是有記憶上的困難，還是沒有辦法專心，或是兩者都有困難呢？"></asp:Label>
        <asp:RadioButtonList ID="rb_9" runat="server">
             <asp:ListItem>沒有問題(10)</asp:ListItem>
             <asp:ListItem>有記憶上的困難(7)</asp:ListItem>
             <asp:ListItem>記憶、專注力都有困難(4)</asp:ListItem>
        </asp:RadioButtonList>

        <asp:Label runat="server" Text="10. 請問您在自我照顧上有困難嗎，例如吃飯、穿脫衣服、站立、室內走動、上廁所、洗澡？"></asp:Label>
        <asp:RadioButtonList ID="rb_10" runat="server">
             <asp:ListItem>沒有困難(10)</asp:ListItem>
             <asp:ListItem>有點困難(7)</asp:ListItem>
             <asp:ListItem>相當困難(4)</asp:ListItem>
        </asp:RadioButtonList>
